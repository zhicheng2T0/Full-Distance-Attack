...
image_path = r"/content/adversarial_cloth/data/INRIAPerson/Test/"                       #  Picture storage path , Fixed path
...
annotations_path = r"/content/adversarial_cloth/data/INRIAPerson/Test/annotations" # Folder Directory  # INRIA Label storage path
...
def text_create(name,bnd):
   full_path = r"/content/adversarial_cloth/data/INRIAPerson/Test/labels1/%s.txt"%(name)
...
def get_size(image_id):
   im = Image.open(r'/content/adversarial_cloth/data/INRIAPerson/Test/pos/%s'%(image_id))       #  Source image storage path
   size = im.size
   w = size[0]
   h = size[1]
   return (w,h)
...
for image_set in sets:
   if not os.path.exists(r'/content/adversarial_cloth/data/INRIAPerson/Test/labels1'):
      os.makedirs(r'/content/adversarial_cloth/data/INRIAPerson/Test/labels1')                     #  Generated yolo3 Label storage path , Fixed path
