...
val_files_num = 0
test_files_num = 0
voc_annotations = r'/home/hulab/zhicheng/codes/adversarial_cloth/data/INRIAPerson/Test/Annotations/'  # voc的annotations路径

split = voc_annotations.split('/')
coco_name = 'VOC2007'

main_path = r'/home/hulab/zhicheng/codes/adversarial_cloth/data/INRIAPerson/'
...
def convert(xml_files, json_file):
    ...
    for xml_file in xml_files:
        ...
        #temp_name=filename[0:len(filename)-4]+'.png'
        #print(‘-----------------here---------------’)
        image = {
            "file_name": filename,
            "height": height,
...
convert(xml_val_files, coco_json_annotations + 'instances_valgarbage2017.json')

convert(xml_train_files, coco_json_annotations + 'instances_test2017.json')
...
#os.mkdir( '/content/adversarial_cloth/data/INRIAPerson/VOC2007_COCO/images/')


coco_train = os.path.join(main_path, coco_name + '_COCO')
# os.makedirs(coco_train+"\\train")
os.makedirs(coco_train + "/val_garbage_2017")
src_dir = coco_images
dst_dir = coco_train + "/val_garbage_2017/"  # 目的路径记得加斜杠
...
train_dir_1 = os.path.join(main_path, coco_name + '_COCO/test_images')
train_dir_2 = os.path.join(main_path, coco_name + '_COCO/test2017')
